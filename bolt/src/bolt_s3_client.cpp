...
const char* BoltS3Client::SERVICE_NAME = "s3";
const char* BoltS3Client::ALLOCATION_TAG = "BoltS3Client";

BoltS3Client::BoltS3Client(const S3::S3ClientConfiguration& clientConfiguration, std::shared_ptr<S3EndpointProviderBase> endpointProvider)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<BoltSigner>(ALLOCATION_TAG, Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG), SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region),
...
BoltS3Client::BoltS3Client(const AWSCredentials& credentials, std::shared_ptr<S3EndpointProviderBase> endpointProvider, const S3::S3ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<BoltSigner>(ALLOCATION_TAG, Aws::MakeShared<SimpleAWSCredentialsProvider>(ALLOCATION_TAG, credentials), SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region),
                                            clientConfiguration.payloadSigningPolicy, false),
                Aws::MakeShared<S3ErrorMarshaller>(ALLOCATION_TAG)),
      m_clientConfiguration(clientConfiguration),
      m_executor(clientConfiguration.executor),
      m_endpointProvider(std::move(endpointProvider)) {
...
BoltS3Client::BoltS3Client(const std::shared_ptr<AWSCredentialsProvider>& credentialsProvider, std::shared_ptr<S3EndpointProviderBase> endpointProvider, const S3::S3ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<BoltSigner>(ALLOCATION_TAG, credentialsProvider, SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region), clientConfiguration.payloadSigningPolicy,
...
BoltS3Client::BoltS3Client(const Client::ClientConfiguration& clientConfiguration, Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads /*= Never*/, bool useVirtualAddressing /*= true*/,
                           Aws::S3::US_EAST_1_REGIONAL_ENDPOINT_OPTION USEast1RegionalEndPointOption)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<BoltSigner>(ALLOCATION_TAG, Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG), SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region), signPayloads,
                                            /*doubleEncodeValue*/ false),
                Aws::MakeShared<S3ErrorMarshaller>(ALLOCATION_TAG)),
...
BoltS3Client::BoltS3Client(const AWSCredentials& credentials, const Client::ClientConfiguration& clientConfiguration, Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads /*= Never*/, bool useVirtualAddressing /*= true*/,
                           Aws::S3::US_EAST_1_REGIONAL_ENDPOINT_OPTION USEast1RegionalEndPointOption)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<BoltSigner>(ALLOCATION_TAG, Aws::MakeShared<SimpleAWSCredentialsProvider>(ALLOCATION_TAG, credentials), SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region), signPayloads,
                                            /*doubleEncodeValue*/ false),
                Aws::MakeShared<S3ErrorMarshaller>(ALLOCATION_TAG)),
      m_clientConfiguration(clientConfiguration, signPayloads, useVirtualAddressing, USEast1RegionalEndPointOption),
      m_executor(clientConfiguration.executor),
...
BoltS3Client::BoltS3Client(const std::shared_ptr<AWSCredentialsProvider>& credentialsProvider, const Client::ClientConfiguration& clientConfiguration, Aws::Client::AWSAuthV4Signer::PayloadSigningPolicy signPayloads /*= Never*/,
                           bool useVirtualAddressing /*= true*/, Aws::S3::US_EAST_1_REGIONAL_ENDPOINT_OPTION USEast1RegionalEndPointOption)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<BoltSigner>(ALLOCATION_TAG, credentialsProvider, SERVICE_NAME, Aws::Region::ComputeSignerRegion(clientConfiguration.region), signPayloads,
                                            /*doubleEncodeValue*/ false),
                Aws::MakeShared<S3ErrorMarshaller>(ALLOCATION_TAG)),
      m_clientConfiguration(clientConfiguration, signPayloads, useVirtualAddressing, USEast1RegionalEndPointOption),
      m_executor(clientConfiguration.executor),
...
void BoltS3Client::init(const S3::S3ClientConfiguration& config) {
  ...
  m_endpointProvider->AccessClientContextParameters().SetForcePathStyle(true);
}

void BoltS3Client::OverrideEndpoint(const Aws::String& endpoint) {
  AWS_CHECK_PTR(SERVICE_NAME, m_endpointProvider);
  m_endpointProvider->OverrideEndpoint(endpoint);
}

AbortMultipartUploadOutcome BoltS3Client::AbortMultipartUpload(const AbortMultipartUploadRequest& request) const {
...
CompleteMultipartUploadOutcome BoltS3Client::CompleteMultipartUpload(const CompleteMultipartUploadRequest& request) const {
...
CopyObjectOutcome BoltS3Client::CopyObject(const CopyObjectRequest& request) const {
...
CreateBucketOutcome BoltS3Client::CreateBucket(const CreateBucketRequest& request) const {
...
CreateMultipartUploadOutcome BoltS3Client::CreateMultipartUpload(const CreateMultipartUploadRequest& request) const {
...
DeleteBucketOutcome BoltS3Client::DeleteBucket(const DeleteBucketRequest& request) const {
...
DeleteBucketAnalyticsConfigurationOutcome BoltS3Client::DeleteBucketAnalyticsConfiguration(const DeleteBucketAnalyticsConfigurationRequest& request) const {
...
DeleteBucketCorsOutcome BoltS3Client::DeleteBucketCors(const DeleteBucketCorsRequest& request) const {
...
DeleteBucketEncryptionOutcome BoltS3Client::DeleteBucketEncryption(const DeleteBucketEncryptionRequest& request) const {
...
DeleteBucketIntelligentTieringConfigurationOutcome BoltS3Client::DeleteBucketIntelligentTieringConfiguration(const DeleteBucketIntelligentTieringConfigurationRequest& request) const {
...
DeleteBucketInventoryConfigurationOutcome BoltS3Client::DeleteBucketInventoryConfiguration(const DeleteBucketInventoryConfigurationRequest& request) const {
...
DeleteBucketLifecycleOutcome BoltS3Client::DeleteBucketLifecycle(const DeleteBucketLifecycleRequest& request) const {
...
DeleteBucketMetricsConfigurationOutcome BoltS3Client::DeleteBucketMetricsConfiguration(const DeleteBucketMetricsConfigurationRequest& request) const {
...
DeleteBucketOwnershipControlsOutcome BoltS3Client::DeleteBucketOwnershipControls(const DeleteBucketOwnershipControlsRequest& request) const {
...
DeleteBucketPolicyOutcome BoltS3Client::DeleteBucketPolicy(const DeleteBucketPolicyRequest& request) const {
...
DeleteBucketReplicationOutcome BoltS3Client::DeleteBucketReplication(const DeleteBucketReplicationRequest& request) const {
...
DeleteBucketTaggingOutcome BoltS3Client::DeleteBucketTagging(const DeleteBucketTaggingRequest& request) const {
...
DeleteBucketWebsiteOutcome BoltS3Client::DeleteBucketWebsite(const DeleteBucketWebsiteRequest& request) const {
...
DeleteObjectOutcome BoltS3Client::DeleteObject(const DeleteObjectRequest& request) const {
...
DeleteObjectTaggingOutcome BoltS3Client::DeleteObjectTagging(const DeleteObjectTaggingRequest& request) const {
...
DeleteObjectsOutcome BoltS3Client::DeleteObjects(const DeleteObjectsRequest& request) const {
...
DeletePublicAccessBlockOutcome BoltS3Client::DeletePublicAccessBlock(const DeletePublicAccessBlockRequest& request) const {
...
GetBucketAccelerateConfigurationOutcome BoltS3Client::GetBucketAccelerateConfiguration(const GetBucketAccelerateConfigurationRequest& request) const {
...
GetBucketAclOutcome BoltS3Client::GetBucketAcl(const GetBucketAclRequest& request) const {
...
GetBucketAnalyticsConfigurationOutcome BoltS3Client::GetBucketAnalyticsConfiguration(const GetBucketAnalyticsConfigurationRequest& request) const {
...
GetBucketCorsOutcome BoltS3Client::GetBucketCors(const GetBucketCorsRequest& request) const {
...
GetBucketEncryptionOutcome BoltS3Client::GetBucketEncryption(const GetBucketEncryptionRequest& request) const {
...
GetBucketIntelligentTieringConfigurationOutcome BoltS3Client::GetBucketIntelligentTieringConfiguration(const GetBucketIntelligentTieringConfigurationRequest& request) const {
...
GetBucketInventoryConfigurationOutcome BoltS3Client::GetBucketInventoryConfiguration(const GetBucketInventoryConfigurationRequest& request) const {
...
GetBucketLifecycleConfigurationOutcome BoltS3Client::GetBucketLifecycleConfiguration(const GetBucketLifecycleConfigurationRequest& request) const {
...
GetBucketLocationOutcome BoltS3Client::GetBucketLocation(const GetBucketLocationRequest& request) const {
...
GetBucketLoggingOutcome BoltS3Client::GetBucketLogging(const GetBucketLoggingRequest& request) const {
...
GetBucketMetricsConfigurationOutcome BoltS3Client::GetBucketMetricsConfiguration(const GetBucketMetricsConfigurationRequest& request) const {
...
GetBucketNotificationConfigurationOutcome BoltS3Client::GetBucketNotificationConfiguration(const GetBucketNotificationConfigurationRequest& request) const {
...
GetBucketOwnershipControlsOutcome BoltS3Client::GetBucketOwnershipControls(const GetBucketOwnershipControlsRequest& request) const {
...
GetBucketPolicyOutcome BoltS3Client::GetBucketPolicy(const GetBucketPolicyRequest& request) const {
...
GetBucketPolicyStatusOutcome BoltS3Client::GetBucketPolicyStatus(const GetBucketPolicyStatusRequest& request) const {
...
GetBucketReplicationOutcome BoltS3Client::GetBucketReplication(const GetBucketReplicationRequest& request) const {
...
GetBucketRequestPaymentOutcome BoltS3Client::GetBucketRequestPayment(const GetBucketRequestPaymentRequest& request) const {
...
GetBucketTaggingOutcome BoltS3Client::GetBucketTagging(const GetBucketTaggingRequest& request) const {
...
GetBucketVersioningOutcome BoltS3Client::GetBucketVersioning(const GetBucketVersioningRequest& request) const {
...
GetBucketWebsiteOutcome BoltS3Client::GetBucketWebsite(const GetBucketWebsiteRequest& request) const {
...
GetObjectOutcome BoltS3Client::GetObject(const GetObjectRequest& request) const {
...
GetObjectOutcomeCallable BoltS3Client::GetObjectCallable(const GetObjectRequest& request) const {
...
void BoltS3Client::GetObjectAsync(const GetObjectRequest& request, const GetObjectResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context) const {
  m_executor->Submit([this, request, handler, context]() { handler(this, request, GetObject(request), context); });
}

GetObjectAclOutcome BoltS3Client::GetObjectAcl(const GetObjectAclRequest& request) const {
...
GetObjectAttributesOutcome BoltS3Client::GetObjectAttributes(const GetObjectAttributesRequest& request) const {
...
GetObjectLegalHoldOutcome BoltS3Client::GetObjectLegalHold(const GetObjectLegalHoldRequest& request) const {
...
GetObjectLockConfigurationOutcome BoltS3Client::GetObjectLockConfiguration(const GetObjectLockConfigurationRequest& request) const {
...
GetObjectRetentionOutcome BoltS3Client::GetObjectRetention(const GetObjectRetentionRequest& request) const {
...
GetObjectTaggingOutcome BoltS3Client::GetObjectTagging(const GetObjectTaggingRequest& request) const {
...
GetObjectTorrentOutcome BoltS3Client::GetObjectTorrent(const GetObjectTorrentRequest& request) const {
...
GetPublicAccessBlockOutcome BoltS3Client::GetPublicAccessBlock(const GetPublicAccessBlockRequest& request) const {
...
HeadBucketOutcome BoltS3Client::HeadBucket(const HeadBucketRequest& request) const {
...
HeadObjectOutcome BoltS3Client::HeadObject(const HeadObjectRequest& request) const {
...
ListBucketAnalyticsConfigurationsOutcome BoltS3Client::ListBucketAnalyticsConfigurations(const ListBucketAnalyticsConfigurationsRequest& request) const {
...
ListBucketIntelligentTieringConfigurationsOutcome BoltS3Client::ListBucketIntelligentTieringConfigurations(const ListBucketIntelligentTieringConfigurationsRequest& request) const {
...
ListBucketInventoryConfigurationsOutcome BoltS3Client::ListBucketInventoryConfigurations(const ListBucketInventoryConfigurationsRequest& request) const {
...
ListBucketMetricsConfigurationsOutcome BoltS3Client::ListBucketMetricsConfigurations(const ListBucketMetricsConfigurationsRequest& request) const {
...
ListBucketsOutcome BoltS3Client::ListBuckets() const {
...
ListMultipartUploadsOutcome BoltS3Client::ListMultipartUploads(const ListMultipartUploadsRequest& request) const {
...
ListObjectVersionsOutcome BoltS3Client::ListObjectVersions(const ListObjectVersionsRequest& request) const {
...
ListObjectsOutcome BoltS3Client::ListObjects(const ListObjectsRequest& request) const {
...
ListObjectsV2Outcome BoltS3Client::ListObjectsV2(const ListObjectsV2Request& request) const {
...
ListPartsOutcome BoltS3Client::ListParts(const ListPartsRequest& request) const {
...
PutBucketAccelerateConfigurationOutcome BoltS3Client::PutBucketAccelerateConfiguration(const PutBucketAccelerateConfigurationRequest& request) const {
...
PutBucketAclOutcome BoltS3Client::PutBucketAcl(const PutBucketAclRequest& request) const {
...
PutBucketAnalyticsConfigurationOutcome BoltS3Client::PutBucketAnalyticsConfiguration(const PutBucketAnalyticsConfigurationRequest& request) const {
...
PutBucketCorsOutcome BoltS3Client::PutBucketCors(const PutBucketCorsRequest& request) const {
...
PutBucketEncryptionOutcome BoltS3Client::PutBucketEncryption(const PutBucketEncryptionRequest& request) const {
...
PutBucketIntelligentTieringConfigurationOutcome BoltS3Client::PutBucketIntelligentTieringConfiguration(const PutBucketIntelligentTieringConfigurationRequest& request) const {
...
PutBucketInventoryConfigurationOutcome BoltS3Client::PutBucketInventoryConfiguration(const PutBucketInventoryConfigurationRequest& request) const {
...
PutBucketLifecycleConfigurationOutcome BoltS3Client::PutBucketLifecycleConfiguration(const PutBucketLifecycleConfigurationRequest& request) const {
...
PutBucketLoggingOutcome BoltS3Client::PutBucketLogging(const PutBucketLoggingRequest& request) const {
...
PutBucketMetricsConfigurationOutcome BoltS3Client::PutBucketMetricsConfiguration(const PutBucketMetricsConfigurationRequest& request) const {
...
PutBucketNotificationConfigurationOutcome BoltS3Client::PutBucketNotificationConfiguration(const PutBucketNotificationConfigurationRequest& request) const {
...
PutBucketOwnershipControlsOutcome BoltS3Client::PutBucketOwnershipControls(const PutBucketOwnershipControlsRequest& request) const {
...
PutBucketPolicyOutcome BoltS3Client::PutBucketPolicy(const PutBucketPolicyRequest& request) const {
...
PutBucketReplicationOutcome BoltS3Client::PutBucketReplication(const PutBucketReplicationRequest& request) const {
...
PutBucketRequestPaymentOutcome BoltS3Client::PutBucketRequestPayment(const PutBucketRequestPaymentRequest& request) const {
...
PutBucketTaggingOutcome BoltS3Client::PutBucketTagging(const PutBucketTaggingRequest& request) const {
...
PutBucketVersioningOutcome BoltS3Client::PutBucketVersioning(const PutBucketVersioningRequest& request) const {
...
PutBucketWebsiteOutcome BoltS3Client::PutBucketWebsite(const PutBucketWebsiteRequest& request) const {
...
PutObjectOutcome BoltS3Client::PutObject(const PutObjectRequest& request) const {
...
PutObjectOutcomeCallable BoltS3Client::PutObjectCallable(const PutObjectRequest& request) const {
...
void BoltS3Client::PutObjectAsync(const PutObjectRequest& request, const PutObjectResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context) const {
  m_executor->Submit([this, request, handler, context]() { handler(this, request, PutObject(request), context); });
}

PutObjectAclOutcome BoltS3Client::PutObjectAcl(const PutObjectAclRequest& request) const {
...
PutObjectLegalHoldOutcome BoltS3Client::PutObjectLegalHold(const PutObjectLegalHoldRequest& request) const {
...
PutObjectLockConfigurationOutcome BoltS3Client::PutObjectLockConfiguration(const PutObjectLockConfigurationRequest& request) const {
...
PutObjectRetentionOutcome BoltS3Client::PutObjectRetention(const PutObjectRetentionRequest& request) const {
...
PutObjectTaggingOutcome BoltS3Client::PutObjectTagging(const PutObjectTaggingRequest& request) const {
...
PutPublicAccessBlockOutcome BoltS3Client::PutPublicAccessBlock(const PutPublicAccessBlockRequest& request) const {
...
RestoreObjectOutcome BoltS3Client::RestoreObject(const RestoreObjectRequest& request) const {
...
SelectObjectContentOutcome BoltS3Client::SelectObjectContent(SelectObjectContentRequest& request) const {
...
UploadPartOutcome BoltS3Client::UploadPart(const UploadPartRequest& request) const {
...
UploadPartCopyOutcome BoltS3Client::UploadPartCopy(const UploadPartCopyRequest& request) const {
...
WriteGetObjectResponseOutcome BoltS3Client::WriteGetObjectResponse(const WriteGetObjectResponseRequest& request) const {
...
Aws::String BoltS3Client::GeneratePresignedUrl(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, uint64_t expirationInSeconds) { return GeneratePresignedUrl(bucket, key, method, {}, expirationInSeconds); }

Aws::String BoltS3Client::GeneratePresignedUrl(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, const Http::HeaderValueCollection& customizedHeaders, uint64_t expirationInSeconds) {
...
Aws::String BoltS3Client::GeneratePresignedUrlWithSSES3(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, uint64_t expirationInSeconds) {
...
Aws::String BoltS3Client::GeneratePresignedUrlWithSSES3(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, Http::HeaderValueCollection customizedHeaders, uint64_t expirationInSeconds) {
...
Aws::String BoltS3Client::GeneratePresignedUrlWithSSEKMS(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, const Aws::String& kmsMasterKeyId, uint64_t expirationInSeconds) {
  Aws::Http::HeaderValueCollection headers;
...
Aws::String BoltS3Client::GeneratePresignedUrlWithSSEKMS(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, Http::HeaderValueCollection customizedHeaders, const Aws::String& kmsMasterKeyId,
...
Aws::String BoltS3Client::GeneratePresignedUrlWithSSEC(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, const Aws::String& base64EncodedAES256Key, uint64_t expirationInSeconds) {
  Aws::Http::HeaderValueCollection headers;
...
Aws::String BoltS3Client::GeneratePresignedUrlWithSSEC(const Aws::String& bucket, const Aws::String& key, Aws::Http::HttpMethod method, Http::HeaderValueCollection customizedHeaders, const Aws::String& base64EncodedAES256Key,
                                                       uint64_t expirationInSeconds) {
...
bool BoltS3Client::MultipartUploadSupported() const { return true; }
